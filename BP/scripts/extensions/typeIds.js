// Generated by TypeIDs Updater
// Date: 2025-11-16 15:40:17
// Total: 1902 + 368 items

export const typeIdToID = new Map([
	['minecraft:acacia_boat', 404], // Updated
	['minecraft:acacia_button', -140],
	['minecraft:acacia_chest_boat', 678], // Updated
	['minecraft:acacia_door', 588], // Updated
	...
	['minecraft:acacia_sign', 611], // Updated
	...
	['minecraft:agent_spawn_egg', 514], // Updated
	['minecraft:air', -158], // Updated
	['minecraft:allay_spawn_egg', 666], // Updated
	['minecraft:allium', -831],
	['minecraft:allow', 210],
	['minecraft:amethyst_block', -327],
	['minecraft:amethyst_cluster', -329],
	['minecraft:amethyst_shard', 659], // Updated
	...
	['minecraft:angler_pottery_sherd', 692], // Updated
	['minecraft:anvil', 145],
	['minecraft:apple', 278],
	['minecraft:archer_pottery_sherd', 693], // Updated
	['minecraft:armadillo_scute', 739], // Updated
	['minecraft:armadillo_spawn_egg', 737], // Updated
	['minecraft:armor_stand', 584], // Updated
	['minecraft:arms_up_pottery_sherd', 694], // Updated
	['minecraft:arrow', 325],
	['minecraft:axolotl_bucket', 394],
	['minecraft:axolotl_spawn_egg', 529], // Updated
	...
	['minecraft:bamboo_chest_raft', 690], // Updated
	...
	['minecraft:bamboo_raft', 689], // Updated
	['minecraft:bamboo_sapling', -164],
	['minecraft:bamboo_shelf', -1056], // New
	['minecraft:bamboo_sign', 688], // Updated
	...
	['minecraft:banner', 599], // Updated
	['minecraft:banner_pattern', 822], // Updated
	['minecraft:barrel', -203],
	['minecraft:barrier', -161],
	['minecraft:basalt', -234],
	['minecraft:bat_spawn_egg', 479], // Updated
	['minecraft:beacon', 138],

	['minecraft:bedrock', 7],
	['minecraft:bee_nest', -218],
	['minecraft:bee_spawn_egg', 521], // Updated
	['minecraft:beef', 295],
	...
	['minecraft:birch_boat', 401], // Updated
	['minecraft:birch_button', -141],
	['minecraft:birch_chest_boat', 675], // Updated
	['minecraft:birch_door', 586], // Updated
	...
	['minecraft:birch_sign', 609], // Updated
	...
	['minecraft:black_bundle', 273], // Updated
	...
	['minecraft:black_dye', 420], // Updated
	['minecraft:black_glazed_terracotta', 235],
	['minecraft:black_harness', 749], // Updated
	...
	['minecraft:blade_pottery_sherd', 695], // Updated
	['minecraft:blast_furnace', -196],
	['minecraft:blaze_powder', 455], // Updated
	['minecraft:blaze_rod', 448], // Updated
	['minecraft:blaze_spawn_egg', 482], // Updated
	['minecraft:bleach', 633],
	['minecraft:blue_bundle', 271], // Updated
	...
	['minecraft:blue_dye', 424], // Updated
	['minecraft:blue_egg', 745], // Updated
	['minecraft:blue_glazed_terracotta', 231],
	['minecraft:blue_harness', 750], // Updated
	...
	['minecraft:board', 629], // New
	['minecraft:boat', 821], // Updated
	['minecraft:bogged_spawn_egg', 489], // Updated
	['minecraft:bolt_armor_trim_smithing_template', 734], // Updated
	['minecraft:bone', 440], // Updated
	['minecraft:bone_block', 216],
	['minecraft:bone_meal', 436], // Updated
	['minecraft:book', 412], // Updated
	['minecraft:bookshelf', 47],
	['minecraft:border_block', 212],
	['minecraft:bordure_indented_banner_pattern', 618], // Updated
	['minecraft:bow', 324],
	['minecraft:bowl', 346],
	...
	['minecraft:breeze_spawn_egg', 528], // Updated
	['minecraft:brewer_pottery_sherd', 696], // Updated
	['minecraft:brewing_stand', 457], // Updated
	['minecraft:brick', 408], // Updated
	...
	['minecraft:brown_bundle', 272], // Updated
	...
	['minecraft:brown_dye', 423], // Updated
	['minecraft:brown_egg', 746], // Updated
	['minecraft:brown_glazed_terracotta', 232],
	['minecraft:brown_harness', 751], // Updated
	...
	['minecraft:bundle', 258], // Updated
	['minecraft:burn_pottery_sherd', 697], // Updated
	['minecraft:bush', -1023],
	['minecraft:cactus', 81],
	['minecraft:cactus_flower', -1030],
	['minecraft:cake', 442], // Updated
	['minecraft:cake_block', 92],
	['minecraft:calcite', -326],
	['minecraft:calibrated_sculk_sensor', -580],
	['minecraft:camel_spawn_egg', 683], // Updated
	['minecraft:camera', 630], // Updated
	['minecraft:camera_block', 630],
	['minecraft:campfire', 623], // Updated
	['minecraft:candle', -412],
	['minecraft:candle_cake', -429],
	['minecraft:carpet', 778], // Updated
	['minecraft:carrot', 301],
	['minecraft:carrot_on_a_stick', 549], // Updated
	['minecraft:carrots', 141],
	['minecraft:cartography_table', -200],
	['minecraft:carved_pumpkin', -155],
	['minecraft:cat_spawn_egg', 515], // Updated
	['minecraft:cauldron', 458], // Updated
	['minecraft:cave_spider_spawn_egg', 483], // Updated
	...
	['minecraft:chemistry_table', 815], // Updated
	['minecraft:cherry_boat', 685], // Updated
	['minecraft:cherry_button', -530],
	['minecraft:cherry_chest_boat', 686], // Updated
	...
	['minecraft:cherry_sign', 687], // Updated
	...
	['minecraft:chest', 54],
	['minecraft:chest_boat', 681], // New
	['minecraft:chest_minecart', 414], // Updated
	['minecraft:chicken', 297],
	['minecraft:chicken_spawn_egg', 461], // Updated
	...
	['minecraft:cocoa', 127],
	['minecraft:cocoa_beans', 437], // Updated
	['minecraft:cod', 286],
	['minecraft:cod_bucket', 389],
	['minecraft:cod_spawn_egg', 507], // Updated
	['minecraft:colored_torch_blue', 204],
	['minecraft:colored_torch_bp', 819], // Updated
	['minecraft:colored_torch_green', -963],
	['minecraft:colored_torch_purple', -964],
	['minecraft:colored_torch_red', 202],
	['minecraft:colored_torch_rg', 818], // Updated
	['minecraft:command_block', 137],
	['minecraft:command_block_minecart', 595], // Updated
	['minecraft:comparator', 554], // Updated
	['minecraft:compass', 416], // Updated
	['minecraft:composter', -213],
	['minecraft:compound', 631],
	['minecraft:compound_creator', 238],
	['minecraft:concrete', 804], // Updated
	['minecraft:concrete_powder', 805], // Updated
	['minecraft:conduit', -157],
	['minecraft:cooked_beef', 296],
	['minecraft:cooked_chicken', 298],
	['minecraft:cooked_cod', 290],
	['minecraft:cooked_mutton', 583], // Updated
	['minecraft:cooked_porkchop', 285],
	['minecraft:cooked_rabbit', 311],
	['minecraft:cooked_salmon', 291],
	['minecraft:cookie', 293],
	['minecraft:copper_axe', 769], // Updated
	['minecraft:copper_bars', -1066],
	['minecraft:copper_block', -340],
	['minecraft:copper_boots', 774], // Updated
	['minecraft:copper_bulb', -776],
	['minecraft:copper_chain', -1074],
	['minecraft:copper_chest', -1031],
	['minecraft:copper_chestplate', 772], // Updated
	['minecraft:copper_door', -784],
	['minecraft:copper_golem_spawn_egg', 764], // Updated
	['minecraft:copper_golem_statue', -1039],
	['minecraft:copper_grate', -768],
	['minecraft:copper_helmet', 770], // Updated
	['minecraft:copper_hoe', 769], // Updated
	['minecraft:copper_horse_armor', 775], // New
	['minecraft:copper_ingot', 537], // Updated
	['minecraft:copper_lantern', -1083],
	['minecraft:copper_leggings', 773], // Updated
	['minecraft:copper_nugget', 774], // Updated
	['minecraft:copper_ore', -311],
	['minecraft:copper_pickaxe', 767], // Updated
	['minecraft:copper_shovel', 766], // Updated
	['minecraft:copper_sword', 765], // Updated
	['minecraft:copper_torch', -1082],
	['minecraft:copper_trapdoor', -792],
	['minecraft:coral', 800], // Updated
	['minecraft:coral_block', 782], // Updated
	['minecraft:coral_fan', 791], // Updated
	['minecraft:coral_fan_dead', 792], // Updated
	['minecraft:cornflower', -838],
	['minecraft:cow_spawn_egg', 462], // Updated
	...
	['minecraft:creaking_spawn_egg', 743], // Updated
	['minecraft:creeper_banner_pattern', 614], // Updated
	['minecraft:creeper_head', -968],
	['minecraft:creeper_spawn_egg', 467], // Updated
	...
	['minecraft:crossbow', 607], // Updated
	...
	['minecraft:cyan_bundle', 260], // Updated
	...
	['minecraft:cyan_dye', 426], // Updated
	['minecraft:cyan_glazed_terracotta', 229],
	['minecraft:cyan_harness', 752], // Updated
	...
	['minecraft:danger_pottery_sherd', 698], // Updated
	['minecraft:dark_oak_boat', 405], // Updated
	['minecraft:dark_oak_button', -142],
	['minecraft:dark_oak_chest_boat', 679], // Updated
	['minecraft:dark_oak_door', 589], // Updated
	...
	['minecraft:dark_oak_sign', 612], // Updated
	...
	['minecraft:diamond_horse_armor', 565], // Updated
	...
	['minecraft:disc_fragment_5', 673], // Updated
	['minecraft:dispenser', 23],
	['minecraft:dolphin_spawn_egg', 511], // Updated
	['minecraft:donkey_spawn_egg', 492], // Updated
	['minecraft:double_cut_copper_slab', -368],
	['minecraft:double_oak_slab', 157],
	['minecraft:double_plant', 798], // Updated
	['minecraft:double_stone_block_slab', 787], // Updated
	['minecraft:double_stone_block_slab2', 788], // Updated
	['minecraft:double_stone_block_slab3', 789], // Updated
	['minecraft:double_stone_block_slab4', 790], // Updated
	['minecraft:double_wooden_slab', 801],
	['minecraft:dragon_breath', 592], // Updated
	...
	['minecraft:drowned_spawn_egg', 510], // Updated
	['minecraft:dune_armor_trim_smithing_template', 718], // Updated
	['minecraft:dye', 821], // Updated
	['minecraft:echo_shard', 682], // Updated
	['minecraft:egg', 415], // Updated
	['minecraft:elder_guardian_spawn_egg', 498], // Updated
	...
	['minecraft:ender_dragon_spawn_egg', 534], // Updated
	['minecraft:ender_eye', 459], // Updated
	['minecraft:ender_pearl', 447], // Updated
	['minecraft:enderman_spawn_egg', 468], // Updated
	['minecraft:endermite_spawn_egg', 486], // Updated
	['minecraft:evoker_spawn_egg', 502], // Updated
	['minecraft:experience_bottle', 541], // Updated
	['minecraft:explorer_pottery_sherd', 699], // Updated
	...
	['minecraft:eye_armor_trim_smithing_template', 722], // Updated
	['minecraft:farmland', 60],
	['minecraft:feather', 352],
	['minecraft:fence', 780], // Updated
	['minecraft:fence_gate', 107],
	['minecraft:fermented_spider_eye', 454], // Updated
	['minecraft:fern', -848],
	['minecraft:field_masoned_banner_pattern', 617], // Updated
	['minecraft:filled_map', 445], // Updated
	['minecraft:fire', 51],
	['minecraft:fire_charge', 542], // Updated
	...
	['minecraft:firework_rocket', 551], // Updated
	['minecraft:firework_star', 552], // Updated
	['minecraft:fishing_rod', 417], // Updated
	['minecraft:fletching_table', -201],
	['minecraft:flint', 381],
	['minecraft:flint_and_steel', 323],
	['minecraft:flow_armor_trim_smithing_template', 733], // Updated
	['minecraft:flow_banner_pattern', 621], // Updated
	['minecraft:flow_pottery_sherd', 700], // Updated
	['minecraft:flower_banner_pattern', 613], // Updated
	['minecraft:flower_pot', 547], // Updated
	['minecraft:flowering_azalea', -338],
	['minecraft:flowing_lava', 10],
	['minecraft:flowing_water', 8],
	['minecraft:fox_spawn_egg', 517], // Updated
	['minecraft:frame', 546], // Updated
	['minecraft:frame_block', 199],
	['minecraft:friend_pottery_sherd', 701], // Updated
	['minecraft:frog_spawn', -468],
	['minecraft:frog_spawn_egg', 664], // Updated
	['minecraft:frosted_ice', 207],
	['minecraft:furnace', 61],
	['minecraft:ghast_spawn_egg', 480], // Updated
	['minecraft:ghast_tear', 450], // Updated
	['minecraft:gilded_blackstone', -281],
	['minecraft:glass', 20],
	['minecraft:glass_bottle', 453], // Updated
	['minecraft:glass_pane', 102],
	['minecraft:glistering_melon_slice', 460], // Updated
	['minecraft:globe_banner_pattern', 620], // Updated
	['minecraft:glow_berries', 825], // Updated
	['minecraft:glow_frame', 658], // Updated
	['minecraft:glow_frame_block', -339],
	['minecraft:glow_ink_sac', 536], // Updated
	['minecraft:glow_lichen', -411],
	['minecraft:glow_squid_spawn_egg', 531], // Updated
	['minecraft:glow_stick', 638],
	['minecraft:glowingobsidian', 246],
	['minecraft:glowstone', 89],
	['minecraft:glowstone_dust', 419], // Updated
	['minecraft:goat_horn', 663], // Updated
	['minecraft:goat_spawn_egg', 530], // Updated
	['minecraft:gold_block', 41],
	['minecraft:gold_ingot', 330],
	['minecraft:gold_nugget', 451], // Updated
	...
	['minecraft:golden_horse_armor', 564], // Updated
	...
	['minecraft:gravel', 13],
	['minecraft:gray_bundle', 268], // Updated
	...
	['minecraft:gray_dye', 428], // Updated
	['minecraft:gray_glazed_terracotta', 227],
	['minecraft:gray_harness', 753], // Updated
	...
	['minecraft:green_bundle', 259], // Updated
	...
	['minecraft:green_dye', 422], // Updated
	['minecraft:green_glazed_terracotta', 233],
	['minecraft:green_harness', 754], // Updated
	...
	['minecraft:guardian_spawn_egg', 487], // Updated
	['minecraft:gunpowder', 353],
	['minecraft:guster_banner_pattern', 622], // Updated
	['minecraft:guster_pottery_sherd', 702], // Updated
	['minecraft:hanging_roots', -319],
	['minecraft:happy_ghast_spawn_egg', 748], // Updated
	...
	['minecraft:hard_stained_glass', 816], // Updated
	['minecraft:hard_stained_glass_pane', 817], // Updated
	...
	['minecraft:heart_of_the_sea', 603], // Updated
	['minecraft:heart_pottery_sherd', 703], // Updated
	['minecraft:heartbreak_pottery_sherd', 704], // Updated
	['minecraft:heavy_core', -316],
	['minecraft:heavy_weighted_pressure_plate', 148],
	['minecraft:hoglin_spawn_egg', 523], // Updated
	['minecraft:honey_block', -220],
	['minecraft:honey_bottle', 626],
	['minecraft:honeycomb', 625],
	['minecraft:honeycomb_block', -221],
	['minecraft:hopper', 559], // Updated
	['minecraft:hopper_minecart', 558], // Updated
	['minecraft:horn_coral', -584],
	['minecraft:horn_coral_block', -852],
	['minecraft:horn_coral_fan', -843],
	['minecraft:horn_coral_wall_fan', -137],
	['minecraft:horse_spawn_egg', 484], // Updated
	['minecraft:host_armor_trim_smithing_template', 732], // Updated
	['minecraft:howl_pottery_sherd', 705], // Updated
	['minecraft:husk_spawn_egg', 490], // Updated
	['minecraft:ice', 79],
	...
	['minecraft:iron_golem_spawn_egg', 532], // Updated
	['minecraft:iron_helmet', 368],
	['minecraft:iron_hoe', 356],
	['minecraft:iron_horse_armor', 563], // Updated
	['minecraft:iron_ingot', 329],
	['minecraft:iron_leggings', 370],
	['minecraft:iron_nugget', 601], // Updated
	...
	['minecraft:jungle_boat', 402], // Updated
	['minecraft:jungle_button', -143],
	['minecraft:jungle_chest_boat', 676], // Updated
	['minecraft:jungle_door', 587], // Updated
	...
	['minecraft:jungle_sign', 610], // Updated
	...
	['minecraft:light_blue_bundle', 263], // Updated
	...
	['minecraft:light_blue_dye', 432], // Updated
	['minecraft:light_blue_glazed_terracotta', 223],
	['minecraft:light_blue_harness', 755], // Updated
	...
	['minecraft:light_gray_bundle', 270], // Updated
	...
	['minecraft:light_gray_dye', 427], // Updated
	['minecraft:light_gray_harness', 756], // Updated
	...
	['minecraft:lime_bundle', 257], // Updated
	...
	['minecraft:lime_dye', 430], // Updated
	['minecraft:lime_glazed_terracotta', 225],
	['minecraft:lime_harness', 757], // Updated
	...
	['minecraft:lingering_potion', 594], // Updated
	...
	['minecraft:llama_spawn_egg', 500], // Updated
	['minecraft:lodestone', -222],
	['minecraft:lodestone_compass', 639],
	['minecraft:log', 779], // Updated
	['minecraft:log2', 802], // Updated
	['minecraft:loom', -204],
	['minecraft:mace', 344],
	['minecraft:magenta_bundle', 269], // Updated
	...
	['minecraft:magenta_dye', 433], // Updated
	['minecraft:magenta_glazed_terracotta', 222],
	['minecraft:magenta_harness', 758], // Updated
	...
	['minecraft:magma', 213],
	['minecraft:magma_cream', 456], // Updated
	['minecraft:magma_cube_spawn_egg', 481], // Updated
	['minecraft:mangrove_boat', 671], // Updated
	['minecraft:mangrove_button', -487],
	['minecraft:mangrove_chest_boat', 680], // Updated
	['minecraft:mangrove_door', 669], // Updated
	...
	['minecraft:mangrove_sign', 670], // Updated
	...
	['minecraft:miner_pottery_sherd', 706], // Updated
	['minecraft:mob_spawner', 52],
	['minecraft:mojang_banner_pattern', 616], // Updated
	['minecraft:monster_egg', 801], // Updated
	['minecraft:mooshroom_spawn_egg', 466], // Updated
	...
	['minecraft:mourner_pottery_sherd', 707], // Updated
	...
	['minecraft:mule_spawn_egg', 493], // Updated
	['minecraft:mushroom_stem', -1008],
	['minecraft:mushroom_stew', 282],
	['minecraft:music_disc_11', 576], // Updated
	['minecraft:music_disc_13', 566], // Updated
	['minecraft:music_disc_5', 672], // Updated
	['minecraft:music_disc_blocks', 568], // Updated
	['minecraft:music_disc_cat', 567], // Updated
	['minecraft:music_disc_chirp', 569], // Updated
	['minecraft:music_disc_creator', 810], // Updated
	['minecraft:music_disc_creator_music_box', 811], // Updated
	['minecraft:music_disc_far', 570], // Updated
	['minecraft:music_disc_lava_chicken', 814], // Updated
	['minecraft:music_disc_mall', 571], // Updated
	['minecraft:music_disc_mellohi', 572], // Updated
	['minecraft:music_disc_otherside', 662], // Updated
	['minecraft:music_disc_pigstep', 656], // Updated
	['minecraft:music_disc_precipice', 812], // Updated
	['minecraft:music_disc_relic', 735], // Updated
	['minecraft:music_disc_stal', 573], // Updated
	['minecraft:music_disc_strad', 574], // Updated
	['minecraft:music_disc_tears', 813], // Updated
	['minecraft:music_disc_wait', 577], // Updated
	['minecraft:music_disc_ward', 575], // Updated
	['minecraft:mutton', 582], // Updated
	['minecraft:mycelium', 110],
	['minecraft:name_tag', 580], // Updated
	['minecraft:nautilus_shell', 602], // Updated
	...
	['minecraft:nether_sprouts', 657], // Updated
	['minecraft:nether_star', 550], // Updated
	['minecraft:nether_wart', 316],
	['minecraft:nether_wart_block', 214],
	['minecraft:nether_wart_plant', 115],
	['minecraft:netherbrick', 555], // Updated
	...
	['minecraft:netherite_upgrade_smithing_template', 716], // Updated
	...
	['minecraft:npc_spawn_egg', 497], // Updated
	['minecraft:oak_boat', 400], // Updated
	['minecraft:oak_chest_boat', 674], // Updated
	...
	['minecraft:ocelot_spawn_egg', 477], // Updated
	['minecraft:ochre_froglight', -471],
	['minecraft:ominous_bottle', 627],
	['minecraft:ominous_trial_key', 276], // Updated
	['minecraft:open_eyeblossom', -1018],
	['minecraft:orange_bundle', 264], // Updated
	...
	['minecraft:orange_dye', 434], // Updated
	['minecraft:orange_glazed_terracotta', 221],
	['minecraft:orange_harness', 759], // Updated
	...
	['minecraft:pale_oak_boat', 741], // Updated
	['minecraft:pale_oak_button', -989],
	['minecraft:pale_oak_chest_boat', 742], // Updated
	...
	['minecraft:pale_oak_sign', 743], // Updated
	...
	['minecraft:panda_spawn_egg', 516], // Updated
	['minecraft:paper', 411], // Updated
	['minecraft:parrot_spawn_egg', 505], // Updated
	['minecraft:pearlescent_froglight', -469],
	['minecraft:peony', -867],
	['minecraft:petrified_oak_double_slab', -903],
	['minecraft:petrified_oak_slab', -902],
	['minecraft:phantom_membrane', 606], // Updated
	['minecraft:phantom_spawn_egg', 513], // Updated
	['minecraft:pig_spawn_egg', 463], // Updated
	['minecraft:piglin_banner_pattern', 619], // Updated
	['minecraft:piglin_brute_spawn_egg', 526], // Updated
	['minecraft:piglin_head', -970],
	['minecraft:piglin_spawn_egg', 524], // Updated
	['minecraft:pillager_spawn_egg', 518], // Updated
	['minecraft:pink_bundle', 261], // Updated
	...
	['minecraft:pink_dye', 429], // Updated
	['minecraft:pink_glazed_terracotta', 226],
	['minecraft:pink_harness', 760], // Updated
	...
	['minecraft:planks', 799], // New
	['minecraft:player_head', -967],
	['minecraft:plenty_pottery_sherd', 708], // Updated
	['minecraft:podzol', 243],
	['minecraft:pointed_dripstone', -308],
	['minecraft:poisonous_potato', 304],
	['minecraft:polar_bear_spawn_egg', 499], // Updated
	...
	['minecraft:popped_chorus_fruit', 591], // Updated
	['minecraft:poppy', 38],
	['minecraft:porkchop', 284],
	['minecraft:portal', 90],
	['minecraft:potato', 302],
	['minecraft:potatoes', 142],
	['minecraft:potion', 452], // Updated
	...
	['minecraft:purple_dye', 425], // Updated
	['minecraft:purple_glazed_terracotta', 219],
	['minecraft:purple_harness', 761], // Updated
	...
	['minecraft:rabbit_foot', 560], // Updated
	['minecraft:rabbit_hide', 561], // Updated
	['minecraft:rabbit_spawn_egg', 485], // Updated
	['minecraft:rabbit_stew', 312],
	['minecraft:rail', 66],
	['minecraft:raiser_armor_trim_smithing_template', 730], // Updated
	['minecraft:rapid_fertilizer', 634],
	['minecraft:ravager_spawn_egg', 520], // Updated
	['minecraft:raw_copper', 540], // Updated
	['minecraft:raw_copper_block', -452],
	['minecraft:raw_gold', 539], // Updated
	['minecraft:raw_gold_block', -453],
	['minecraft:raw_iron', 538], // Updated
	['minecraft:raw_iron_block', -451],
	['minecraft:recovery_compass', 682], // Updated
	['minecraft:red_bundle', 265], // Updated
	...
	['minecraft:red_dye', 421], // Updated
	['minecraft:red_flower', 797], // Updated
	['minecraft:red_glazed_terracotta', 234],
	['minecraft:red_harness', 762], // Updated
	...
	['minecraft:sapling', 793], // Updated
	['minecraft:scaffolding', -165],
	['minecraft:scrape_pottery_sherd', 710], // Updated
	['minecraft:sculk', -458],
	...
	['minecraft:sentry_armor_trim_smithing_template', 717], // Updated
	['minecraft:shaper_armor_trim_smithing_template', 731], // Updated
	['minecraft:sheaf_pottery_sherd', 711], // Updated
	['minecraft:shears', 446], // Updated
	['minecraft:sheep_spawn_egg', 464], // Updated
	['minecraft:shelter_pottery_sherd', 712], // Updated
	['minecraft:shield', 380],
	['minecraft:short_dry_grass', -1028],
	['minecraft:short_grass', 31],
	['minecraft:shroomlight', -230],
	['minecraft:shulker_box', 808], // Updated
	['minecraft:shulker_shell', 598], // Updated
	['minecraft:shulker_spawn_egg', 496], // Updated
	['minecraft:silence_armor_trim_smithing_template', 728], // Updated
	['minecraft:silver_glazed_terracotta', 228],
	['minecraft:silverfish_spawn_egg', 469], // Updated
	['minecraft:skeleton_horse_spawn_egg', 494], // Updated
	['minecraft:skeleton_skull', 144],
	['minecraft:skeleton_spawn_egg', 470], // Updated
	['minecraft:skull', 736], // Updated
	['minecraft:skull_banner_pattern', 615], // Updated
	['minecraft:skull_pottery_sherd', 713], // Updated
	['minecraft:slime', 165],
	['minecraft:slime_ball', 413], // Updated
	['minecraft:slime_spawn_egg', 471], // Updated
	...
	['minecraft:sniffer_spawn_egg', 527], // Updated
	['minecraft:snort_pottery_sherd', 714], // Updated
	['minecraft:snout_armor_trim_smithing_template', 725], // Updated
	['minecraft:snow', 80],
	['minecraft:snow_golem_spawn_egg', 533], // Updated
	['minecraft:snow_layer', 78],
	['minecraft:snowball', 399],
	['minecraft:soul_campfire', 658], // Updated
	...
	['minecraft:spawn_egg', 823], // Updated
	['minecraft:spider_eye', 300],
	['minecraft:spider_spawn_egg', 472], // Updated
	['minecraft:spire_armor_trim_smithing_template', 727], // Updated
	['minecraft:splash_potion', 593], // Updated
	['minecraft:sponge', 19],
	['minecraft:spore_blossom', -321],
	['minecraft:spruce_boat', 403], // Updated
	['minecraft:spruce_button', -144],
	['minecraft:spruce_chest_boat', 677], // Updated
	['minecraft:spruce_door', 585], // Updated
	...
	['minecraft:spruce_sign', 608], // Updated
	...
	['minecraft:spyglass', 661], // Updated
	['minecraft:squid_spawn_egg', 476], // Updated
	['minecraft:stained_glass', 806], // Updated
	['minecraft:stained_glass_pane', 807], // Updated
	['minecraft:stained_hardened_clay', 737], // Updated
	...
	['minecraft:stone_block_slab', 783], // Updated
	['minecraft:stone_block_slab2', 784], // Updated
	['minecraft:stone_block_slab3', 785], // Updated
	['minecraft:stone_block_slab4', 786], // Updated
	...
	['minecraft:stonebrick', 781], // Updated
	['minecraft:stonecutter', 245],
	['minecraft:stonecutter_block', -197],
	['minecraft:stray_spawn_egg', 488], // Updated
	['minecraft:strider_spawn_egg', 522], // Updated
	...
	['minecraft:sugar', 441], // Updated
	['minecraft:sugar_cane', 410], // Updated
	['minecraft:sunflower', 175],
	['minecraft:suspicious_gravel', -573],
	['minecraft:suspicious_sand', -529],
	['minecraft:suspicious_stew', 624], // Updated
	['minecraft:sweet_berries', 309],
	['minecraft:sweet_berry_bush', -207],
	['minecraft:tadpole_bucket', 666], // Updated
	['minecraft:tadpole_spawn_egg', 665], // Updated
	['minecraft:tall_dry_grass', -1029],
	['minecraft:tall_grass', -864],
	['minecraft:tallgrass', 801], // Updated
	['minecraft:target', -239],
	['minecraft:tide_armor_trim_smithing_template', 724], // Updated
	['minecraft:tinted_glass', -334],
	['minecraft:tnt', 46],
	['minecraft:tnt_minecart', 557], // Updated
	['minecraft:torch', 50],
	['minecraft:torchflower', -568],
	['minecraft:torchflower_crop', -567],
	['minecraft:torchflower_seeds', 318],
	['minecraft:totem_of_undying', 600], // Updated
	['minecraft:trader_llama_spawn_egg', 684], // Updated
	['minecraft:trapdoor', 96],
	['minecraft:trapped_chest', 146],
	['minecraft:trial_key', 277], // Updated
	['minecraft:trial_spawner', -315],
	['minecraft:trident', 578], // Updated
	...
	['minecraft:tropical_fish_spawn_egg', 506], // Updated
	...
	['minecraft:turtle_helmet', 605], // Updated
	['minecraft:turtle_scute', 604], // Updated
	['minecraft:turtle_spawn_egg', 512], // Updated
	...
	['minecraft:vex_armor_trim_smithing_template', 723], // Updated
	['minecraft:vex_spawn_egg', 503], // Updated
	['minecraft:villager_spawn_egg', 475], // Updated
	['minecraft:vindicator_spawn_egg', 501], // Updated
	['minecraft:vine', 106],
	['minecraft:wall_banner', 177],
	['minecraft:wall_sign', 68],
	['minecraft:wandering_trader_spawn_egg', 518], // Updated
	['minecraft:ward_armor_trim_smithing_template', 721], // Updated
	['minecraft:warden_spawn_egg', 667], // Updated
	...
	['minecraft:wayfinder_armor_trim_smithing_template', 729], // Updated
	...
	['minecraft:white_bundle', 262], // Updated
	...
	['minecraft:white_dye', 435], // Updated
	['minecraft:white_glazed_terracotta', 220],
	['minecraft:white_harness', 763], // Updated
	...
	['minecraft:wild_armor_trim_smithing_template', 720], // Updated
	['minecraft:wildflowers', -1024],
	['minecraft:wind_charge', 275], // Updated
	['minecraft:witch_spawn_egg', 478], // Updated
	['minecraft:wither_rose', -216],
	['minecraft:wither_skeleton_skull', -965],
	['minecraft:wither_skeleton_spawn_egg', 491], // Updated
	['minecraft:wither_spawn_egg', 535], // Updated
	['minecraft:wolf_armor', 740], // Updated
	['minecraft:wolf_spawn_egg', 465], // Updated
	['minecraft:wood', 809], // Updated
	...
	['minecraft:wooden_slab', 796], // Updated
	['minecraft:wooden_sword', 332],
	['minecraft:wool', 777], // Updated
	['minecraft:writable_book', 543], // Updated
	['minecraft:written_book', 544], // Updated
	['minecraft:yellow_bundle', 267], // Updated
	...
	['minecraft:yellow_dye', 431], // Updated
	['minecraft:yellow_glazed_terracotta', 224],
	['minecraft:yellow_harness', 764], // Updated
	...
	['minecraft:zoglin_spawn_egg', 525], // Updated
	['minecraft:zombie_head', -966],
	['minecraft:zombie_horse_spawn_egg', 495], // Updated
	['minecraft:zombie_pigman_spawn_egg', 474], // Updated
	['minecraft:zombie_spawn_egg', 473], // Updated
	['minecraft:zombie_villager_spawn_egg', 504], // Updated
]);
